    ...
    ;;    (define (better-list error)
      ;;    (if (equal? (substring error 0 17) "Select list item:")
       ...
       (define (process-exception ex)
         ...
         (android-log-form "PROCESS EXCEPTION")  ;;JOHANNA
         (android-log-form ex)                   ;;JOHANNA
         (if isrepl
                                ...
                                (try-catch
                                 ...
                                 (exception java.lang.Throwable
                                  (begin
                                    ...
                                    (android-log-form "EXCEPTION")   ;;JOHANNA
                                    (android-log-form eventName)     ;;JOHANNA
                                    (android-log-form componentObject) ;;JOHANNA
